...
def parse_cb_args():
    ...
    parser.add_argument('--inference_steps', type=int, default=19, help='Number of denoising steps for inference on target dataset')
    parser.add_argument('--num_inference_complexes', type=int, default=100, help='Number of complexes for which inference is run every cb_inference_freq epochs (None will run it on all)')
    parser.add_argument('--wandb', action='store_true', default=False, help='')
    parser.add_argument('--project', type=str, default='confidence-bootstrapping', help='')
    ...
    # Dataset
    parser.add_argument('--limit_complexes', type=int, default=0, help='If positive, the number of training and target complexes is capped')
    ...
    parser.add_argument('--target_multiplicity', type=int, default=1, help='')
    ...
    parser.add_argument('--rot_sigma_min', type=float, default=0.06, help='Minimum sigma for rotational component')
    parser.add_argument('--rot_sigma_max', type=float, default=3.1, help='Maximum sigma for rotational component')
    ...
    # Model
    parser.add_argument('--num_conv_layers', type=int, default=5, help='Number of interaction layers')
    ...
    parser.add_argument('--nv', type=int, default=6, help='Number of hidden features per node of order >0')
    ...
    parser.add_argument('--sh_lmax', type=int, default=1, help='Size of the embedding of the diffusion time')
    ...
    parser.add_argument('--buffer_decay', type=float, default=0.0, help='')
