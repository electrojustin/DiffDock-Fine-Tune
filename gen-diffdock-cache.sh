...
python gen_cache.py --config default_inference_args.yaml --protein_file protein --pdbbind_esm_embeddings_path data/plinder_dataset_esm/ --pdbbind_dir data/plinder_dataset/ --split_train data/plinder_dataset/plinder_train_split.txt --split_val ../../../final_allo_only_splits_250604/val_x4.txt --n_epochs 1 --log_dir workdir/delete_me --num_dataloader_workers 48 --dataloader_prefetch_factor 100
