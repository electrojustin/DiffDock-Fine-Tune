...
python train.py --config default_inference_args.yaml --pretrain_dir='workdir/v1.1/score_model/' --pretrain_ckpt='best_ema_inference_epoch_model' --protein_file protein --pdbbind_esm_embeddings_path data/plinder_dataset_esm/ --pdbbind_dir data/plinder_dataset/ --split_train data/plinder_dataset/plinder_train_split.txt --split_val ../../../final_allo_only_splits_250604/val_x4.txt --val_inference_freq 100 --train_inference_freq 100 --n_epochs 7500 --num_dataloader_workers 4 --pin_memory --DDP --num_inference_complexes 50 --wandb --entity jeg10045-new-york-university --project diffdock-tune --run_name plinder --lr 0.0001 --inference_earlystop_avg_infsteps=10

#python train.py --config default_inference_args.yaml --pretrain_dir='workdir/v1.1/score_model/' --pretrain_ckpt='best_ema_inference_epoch_model' --protein_file protein --pdbbind_esm_embeddings_path /vast/eac709/allo_crossdock/DiffDock-L/AlloSet/241120/data/esm2/ --pdbbind_dir data/allosteric_dataset/ --split_train ../../../final_allo_only_splits_250604/train.txt --split_val ../../../final_allo_only_splits_250604/val_x4.txt --val_inference_freq 100 --train_inference_freq 100 --n_epochs 15000 --num_dataloader_workers 4 --pin_memory --DDP --num_inference_complexes 100 --wandb --entity jeg10045-new-york-university --project diffdock-tune --run_name rng_sqrt_0.5_1_1_1 --lr 0.0001 --rng_gamma 0.5 --rng_tr_eps 1.0 --rng_tor_eps 1.0 --rng_rot_eps 1.0 --inference_earlystop_avg_infsteps=10
